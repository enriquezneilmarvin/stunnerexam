...
<head>
  ...
  <link href="{{ asset('public/sb-admin/datatables/dataTables.bootstrap4.css') }}" rel="stylesheet">
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="index.html">Neil Enriquez - Exam </a>
...
<!--   <a class="scroll-to-top rounded" href="#page-top">
  ...
  <!-- <script src=" {{ asset('public/sb-admin/chart.js/Chart.min.js') }} "></script> -->
  <script src=" {{ asset('public/sb-admin/datatables/jquery.dataTables.js') }} "></script>
  <script src=" {{ asset('public/sb-admin/datatables/dataTables.bootstrap4.js') }}"></script>
